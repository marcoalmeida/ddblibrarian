...
const (
	...
	dataSource       = "example_demo_moviedata.json"
)
...
// ExampleBatchJob demonstrates how
func Example_demo() {
	// create the table
	err := setup()
	if err != nil {
	...
	//
	//=> Taking a snapshot, before manual updates...
	//
	//=> Updating movie data (i.e., introducing errors)...
	//
	//=> Movie details -- active entry
	//   The Avengers, 2012: {"This used to contain important movie information"}
	//
	//=> Movie details -- from the snapshot
	//   The Avengers, 2012: {"Directors":["Joss Whedon"],"ReleaseDate":"","Rating":8.2,"Genres":["Action","Fantasy"],"Image":"","Plot":"Nick Fury of S.H.I.E.L.D. assembles a team of superhumans to save the planet from Loki and his army.","Rank":48,"RunningTime":0,"Actors":["Robert Downey Jr.","Chris Evans","Scarlett Johansson"]}
	//
